...
👉 **[(https://huggingface.co/spaces/dbaltae/Proyecto_PDI)]**

##  Estructura del Repositorio
- `/entrenamiento`: Código fuente del entrenamiento del modelo.
- `/despliegue_hf`: Código de configuración y despliegue en Hugging Face Spaces.
- `/executorch_docs`: Documentación del proceso de exportación del modelo utilizando ExecuTorch.
